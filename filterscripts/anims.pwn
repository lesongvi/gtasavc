/*
		Credits:
		(***) 123EatLag
		Do whatever you want with is filterscript but please dont remove the credits thanks,
...
CMD:animlist(playerid, params[])
{
	...
	SendClientMessage(playerid, COLOR_GRAD6, "/helihang /fatanim /clap /colt /pose /carry /camera /boxwalk /baseball");
...
CMD:fallover(playerid, params[])
{
	...
	case 6: ApplyAnimation(playerid, "FINALE", "FIN_Land_Die", 4.1, 0, 1, 1, 1, 1, 1);
	default: SendClientMessage(playerid, COLOR_WHITE, "USAGE: /fallover [1-6]");
	}
	return 1;
}
...
CMD:pedmove(playerid, params[])
{
	...
	case 27: PlayAnimEx(playerid, "WUZI", "CS_Plyr_pt1", 2.0, 1, 1, 1, 1, 1, 1);
...
CMD:smoke(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "USAGE: /smoke [1-3]");
	}
	return 1;
}
...
CMD:cheer(playerid, params[])
{
	...
	case 9: ApplyAnimation(playerid, "benchpress", "gym_bp_celebrate", 4.1, 0, 1, 1, 1, 1, 1);
	default: SendClientMessage(playerid, COLOR_WHITE, "USAGE: /cheer [1-9]");
	}
	return 1;
}
...
CMD:siteat(playerid, params[])
{
	...
	case 3: ApplyAnimation(playerid, "FOOD", "EAT_Vomit_P", 4.1, 0, 1, 1, 1, 1, 1);
	case 4: ApplyAnimation(playerid, "FOOD", "FF_Die_Bkw", 4.1, 0, 1, 1, 1, 1, 1);
	case 5: ApplyAnimation(playerid, "FOOD", "FF_Die_Fwd", 4.1, 0, 1, 1, 1, 1, 1);
	case 6: ApplyAnimation(playerid, "FOOD", "FF_Die_Left", 4.1, 0, 1, 1, 1, 1, 1);
	default: SendClientMessage(playerid, COLOR_WHITE, "USAGE: /siteat [1-6]");
	}
	return 1;
}
...
CMD:bar(playerid, params[])
{
	...
	case 6: ApplyAnimation(playerid, "BAR", "Barserve_in", 4.1, 0, 1, 1, 1, 1, 1);
...
CMD:sitonchair(playerid, params[])
{
		...
		switch(strval(params))
		{
        case 1: PlayAnim(playerid, "Attractors", "Stepsit_in", 4.0, 0, 0, 0, 1, 0, 1);
        case 2: PlayAnim(playerid,"CRIB","PED_Console_Loop",4.0,1,0,0,0,0, 1);
        case 3: PlayAnim(playerid,"INT_HOUSE","LOU_In",4.0,0,0,0,1,0, 1);
        case 4: PlayAnim(playerid,"MISC","SEAT_LR",4.0,1,0,0,0,0, 1);
        case 5: PlayAnim(playerid,"MISC","Seat_talk_01",4.0,1,0,0,0,0, 1);
        case 6: PlayAnim(playerid,"MISC","Seat_talk_02",4.0,1,0,0,0,0, 1);
        case 7: PlayAnim(playerid,"ped","SEAT_down",4.0,0,0,0,1,0, 1);
...
CMD:blowjob(playerid, params[])
{
	...
	case 3: ApplyAnimation(playerid, "BLOWJOBZ", "BJ_STAND_LOOP_P", 4.1, 0, 1, 1, 1, 1, 1);
	case 4: ApplyAnimation(playerid, "BLOWJOBZ", "BJ_STAND_LOOP_W", 4.1, 0, 1, 1, 1, 1, 1);
...
CMD:idles(playerid, params[])
{
	...
	case 16: ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_nod", 4.1, 0, 1, 1, 1, 1, 1);
	default: SendClientMessage(playerid, COLOR_WHITE, "USAGE: /idles [1-16]");
	}
	return 1;
}
...
CMD:baseball(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: ApplyAnimation(playerid, "BASEBALL", "Bat_4", 4.1, 0, 1, 1, 1, 1, 1);
	case 2: ApplyAnimation(playerid, "BASEBALL", "Bat_block", 4.1, 0, 1, 1, 1, 1, 1);
	case 3: ApplyAnimation(playerid, "BASEBALL", "Bat_Hit_2", 4.1, 0, 1, 1, 1, 1, 1);
	default: SendClientMessage(playerid, COLOR_WHITE, "USAGE: /baseball [1-2]");
	}
	return 1;
}

	
CMD:boxwalk(playerid, params[])
{
	if(!IsAblePedAnimation(playerid)) return 1;
	switch(strval(params))
	{
	case 1: ApplyAnimation(playerid, "BOX", "bxhipwlk", 4.1, 1, 1, 1, 1, 1, 1);
	case 2: ApplyAnimation(playerid, "BOX", "bxshwlk", 4.1, 1, 1, 1, 1, 1, 1);
	case 3: ApplyAnimation(playerid, "BOX", "catch_box", 4.1, 1, 1, 1, 1, 1, 1);
	default: SendClientMessage(playerid, COLOR_WHITE, "Syntax: /boxwalk [1 - 3]");
	}
	return 1;
}
...
CMD:camera(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		case 3: ApplyAnimation(playerid, "CAMERA", "camcrch_to_camstnd", 4.1, 0, 1, 1, 1, 1, 1);
		case 4: ApplyAnimation(playerid, "CAMERA", "camstnd_cmon", 4.1, 0, 1, 1, 1, 1, 1);
		case 5: ApplyAnimation(playerid, "CAMERA", "piccrch_in", 4.1, 0, 1, 1, 1, 1, 1);
		default: SendClientMessage(playerid, COLOR_WHITE, "Syntax: /camera [1 - 5]");
	}
	return 1;
}
...
CMD:pose(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: ApplyAnimation(playerid, "CLOTHES", "CLO_Pose_Hat", 4.1, 1, 1, 1, 1, 1, 1);
 	case 2: ApplyAnimation(playerid, "CLOTHES", "CLO_Pose_Loop", 4.1, 0, 1, 1, 1, 1, 1);
  	default: SendClientMessage(playerid, COLOR_WHITE, "Syntax: /pose [1 - 2]");
  	}
	return 1;
}
...
CMD:colt(playerid, params[])
{
	...
	switch(strval(params))
	{
		    case 1: ApplyAnimation(playerid, "COLT45", "colt45_reload", 4.1, 0, 1, 1, 1, 1, 1);
		    case 2: ApplyAnimation(playerid, "COLT45", "sawnoff_reload", 4.1, 0, 1, 1, 1, 1, 1);
		    default: SendClientMessage(playerid, COLOR_WHITE, "Syntax: /colt [1 - 2]");
 	}
	return 1;
}
...
CMD:fatanim(playerid, params[])
{
	if(!IsAblePedAnimation(playerid)) return 1;
	switch(strval(params))
	{
			case 1: ApplyAnimation(playerid, "FAT", "FatRun", 4.1, 1, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "FAT", "FatRun_armed", 4.1, 1, 1, 1, 1, 1, 1);
			case 3: ApplyAnimation(playerid, "FAT", "FatSprint", 4.1, 1, 1, 1, 1, 1, 1);
			case 4: ApplyAnimation(playerid, "FAT", "FatWalk_armed", 4.1, 1, 1, 1, 1, 1, 1);
			default: SendClientMessage(playerid, COLOR_WHITE, "Syntax: /fatanim [1 - 4]");
	}
	return 1;
}
	
	
CMD:helihang(playerid, params[])
{
	if(!IsAbleVehicleAnimation(playerid)) return 1;
